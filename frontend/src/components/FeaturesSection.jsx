        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
              ...
              <p className="text-gray-600">From electronics to industrial equipment, we have you covered.</p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
              ...
              <p className="text-gray-600">Tailored services to meet your unique business requirements.</p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
              ...
              <p className="text-gray-600">Dedicated team to assist you every step of the way.</p>
            </div>
          </div>
        </div>
      </section>
